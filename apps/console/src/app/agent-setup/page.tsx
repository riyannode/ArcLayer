    ...
    <div className="min-h-screen overflow-hidden bg-[#050607] text-[#EAE4D8]">
      ...
      <main className="relative mx-auto max-w-2xl px-4 py-10">
        ...
        <div className="mb-5 rounded-lg border border-white/10 bg-[#07090D]/88 px-7 py-5 shadow-[0_0_0_1px_rgba(0,0,0,0.25)]">
          ...
          <div className="mt-5">{isConnected && address ? <AgentIdentityMcpSessionCard ownerAddress={address} /> : <div className="rounded-md border border-white/10 bg-black/20 px-5 py-4 text-[13px] text-[#EAE4D8]/55">Connect your wallet to connect Codex.</div>}</div>
          <p className="mt-4 text-[12px] leading-5 text-[#EAE4D8]/42">After Codex is connected, ask Codex to create an Agent Bundle. Codex will return a browser mint URL. Bot runtime, Runner, payer wallet, Gateway balance, live ERC-8183 execution, and x402 execution happen later.</p>
        </div>
