    ...
    <div className="min-h-screen overflow-hidden bg-[#050607] text-[#EAE4D8]">
      ...
      <main className="relative mx-auto max-w-2xl px-4 py-10">
        ...
        <section className="mb-6">
          ...
          <p className="mt-3 text-[13px] leading-6 text-[#EAE4D8]/62">Start with an MCP Agent Bundle for identity, manifest, role metadata, and ArcLayer API key readiness. Run a self-hosted runtime through the External Agent setup.</p>
        </section>
