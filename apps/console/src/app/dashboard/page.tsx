              ...
              <div className="space-y-3">
                {filteredJobs.map((job) => (
                  <article
                    ...
                    tabIndex={0}
                    role="button"
                    className="group relative grid cursor-pointer gap-4 rounded-xl border border-[#C5A67C]/12 bg-[#090B0E]/55 px-5 py-4 shadow-[0_0_0_1px_rgba(197,166,124,0.03)] transition hover:border-[#F0B84A]/32 hover:bg-[#0D0F12]/75 hover:shadow-[0_0_0_1px_rgba(240,184,74,0.10)] xl:grid-cols-[minmax(0,1fr)_160px_180px_170px_160px] xl:items-center"
                  >
