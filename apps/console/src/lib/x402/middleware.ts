...
const X402_REQUIRED_PAY_TO = '0x4aA3402575b6D98EacE35A823EFa267F7365bdD2';

function resolvePayTo(override?: `0x${string}`): `0x${string}` {
  if (override) return getAddress(override) as `0x${string}`;
  const env = process.env.X402_RECEIVER_ADDRESS || process.env.X402_PAY_TO || X402_REQUIRED_PAY_TO;
