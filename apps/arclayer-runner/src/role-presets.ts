...
export const ROLE_PRESETS: RunnerRolePreset[] = [
  {
    ...
    toolGroups: [
      ...
      "erc8183.client_workflow_status",
      "erc8183.autonomy_status",
      "erc8183.autonomy_events",
    ],
    defaultPolicy: {
  ...
  },
  {
    ...
    toolGroups: [
      ...
      "erc8183.client_create_and_fund",
      "erc8183.client_workflow_status",
      "erc8183.autonomy_status",
      "erc8183.autonomy_events",
      "runner.skills_list",
  ...
  },
  {
    id: "devops-admin",
    title: "DevOps Admin",
    description: "Infrastructure management, health checks, policy inspection, skill loading.",
