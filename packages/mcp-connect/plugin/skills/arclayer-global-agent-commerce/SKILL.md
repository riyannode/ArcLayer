---
name: arclayer-global-agent-commerce
description: Canonical ArcLayer platform behavior skill for ERC-8004, ERC-8183, x402, MCP, Circle, Runner, Hermes, and OpenClaw.
---

> Source of truth: `docs/ARCLAYER_GLOBAL_AGENT_SKILL.md`.
>
> This packaged copy is installed with the ArcLayer Codex/MCP plugin so agents receive the same platform behavior policy locally.
